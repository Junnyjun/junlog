...
* [☕ JAVA](clean-architecture/README.md)
  * [Basic](jvm/clean-architecture/basic/README.md)
    * [Yield](jvm/clean-architecture/basic/yield.md)
    * [SOAP](jvm/clean-architecture/basic/soap.md)
    * [Ciper](jvm/clean-architecture/basic/ciper.md)
    * [Final](jvm/clean-architecture/basic/final.md)
    * [Enhanced java beans](jvm/clean-architecture/basic/enhanced-java-beans.md)
    * [Lambda](jvm/clean-architecture/basic/lambda.md)
    * [Instance Cache](jvm/clean-architecture/basic/instance-cache.md)
    * [New Builder ?](jvm/clean-architecture/basic/fun-new-builder.md)
    * [try-catch](jvm/clean-architecture/basic/chap1/README.md)
      * [Remove resource](jvm/clean-architecture/basic/chap1/fun-remove-resource.md)
  ...
  * [Netty](jvm/clean-architecture/netty/README.md)
    * [base](jvm/clean-architecture/netty/base/README.md)
      * [UDP](jvm/clean-architecture/netty/base/udp.md)
      * [TCP](jvm/clean-architecture/netty/base/tcp.md)
